...
<body>
    ...
    <section>
        <article class="share-photo" style="display:none">
            <div class="tit">전달받은 이미지</div>
            <div class="imgWrap">
                <img src="img/output_2054946964.jpg" alt="전받받은 재료 이미지">
            </div>
        </article>
        <article class="list-page">
            <img src="data:image/jpeg;base64, <%= base64Image %>" />
            <p>감자, 고구마, 양파, 피자, 치킨 신의 가호를 받을것</p>
        ...
        fetch(apiUrl)
            ...
            .then(data => {
                if (data.image) {
                    ...
                    post_num.href = "detail.jsp?postId=" + data.id;
                    //
